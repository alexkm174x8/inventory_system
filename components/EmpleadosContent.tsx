    ...
    <div className="bg-white rounded-lg border border-[#e6e6e6] shadow-sm mt-8">
      ...
      {loading ? (
        <div className="flex justify-center items-center py-12">
          <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-[#1366D9]"></div>
        </div>
      ) : error ? (
        ...
        <div className="overflow-x-auto">
          ...
          <div className="px-6 py-4 border-t border-[#e6e6e6] flex justify-between items-center">
            ...
            className={`border-2 px-3 py-2 flex items-center gap-2 rounded-sm ${(currentPage === 1 || loading) ? 'opacity-50 cursor-not-allowed' : ''}`}
            >
            ...
            className={`border-2 px-3 py-2 flex items-center gap-2 rounded-sm ${(currentPage === totalPages || loading) ? 'opacity-50 cursor-not-allowed' : ''}`}
            >
